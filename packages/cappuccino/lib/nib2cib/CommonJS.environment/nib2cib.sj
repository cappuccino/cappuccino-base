...
p;11;Converter.jt;6835;@STATIC;1.0;I;21;Foundation/CPObject.jI;20;Foundation/CPArray.jI;19;Foundation/CPData.jI;24;Foundation/CPException.jI;21;Foundation/CPString.jI;19;BlendKit/BlendKit.ji;14;NSFoundation.ji;10;NSAppKit.jt;6628;objj_executeFile("Foundation/CPObject.j", NO);objj_executeFile("Foundation/CPArray.j", NO);objj_executeFile("Foundation/CPData.j", NO);objj_executeFile("Foundation/CPException.j", NO);objj_executeFile("Foundation/CPString.j", NO);objj_executeFile("BlendKit/BlendKit.j", NO);objj_executeFile("NSFoundation.j", YES);objj_executeFile("NSAppKit.j", YES);var FILE = require("file"),
    OS = require("os"),
    SharedConverter = nil;
...
{
    self = (objj_getClass("Converter").super_class.method_dtable["init"] || _objj_forward)(self, "init");
    if (self)
    {
        if (!SharedConverter)
...
,["id","CPString","CPString"]), new objj_method(sel_getUid("convert"), function $Converter__convert(self, _cmd)
{
    ...
    var nibData = (self.isa.method_msgSend["CPCompliantNibDataAtFilePath:"] || _objj_forward)(self, "CPCompliantNibDataAtFilePath:", self.inputPath);
    if (inferredFormat === NibFormatMac)
        var convertedData = (self.isa.method_msgSend["convertedDataFromMacData:"] || _objj_forward)(self, "convertedDataFromMacData:", nibData);
    else
        (CPException.isa.method_msgSend["raise:reason:"] || _objj_forward)(CPException, "raise:reason:", ConverterConversionException, "nib2cib does not understand this nib format.");
    if (((___r1 = self.outputPath), ___r1 == null ? null : (___r1.isa.method_msgSend["length"] || _objj_forward)(___r1, "length")))
        FILE.write(self.outputPath, (convertedData == null ? null : (convertedData.isa.method_msgSend["rawString"] || _objj_forward)(convertedData, "rawString")), {charset: "UTF-8"});
...
,["CPData"]), new objj_method(sel_getUid("CPCompliantNibDataAtFilePath:"), function $Converter__CPCompliantNibDataAtFilePath_(self, _cmd, aFilePath)
{
    ...
    try {
        if (((___r1 = self.outputPath), ___r1 == null ? null : (___r1.isa.method_msgSend["length"] || _objj_forward)(___r1, "length")))
        {
            ...
            try {
                ...
                if (p.wait() === 1)
                    (CPException.isa.method_msgSend["raise:reason:"] || _objj_forward)(CPException, "raise:reason:", ConverterConversionException, "Could not compile file: " + aFilePath);
            }
            finally {
                p.stdin.close();
                p.stdout.close();
        ...
        try {
            ...
            if (p.wait() === 1)
                (CPException.isa.method_msgSend["raise:reason:"] || _objj_forward)(CPException, "raise:reason:", ConverterConversionException, "Could not convert to xml plist for file: " + aFilePath);
        }
        finally {
            p.stdin.close();
            p.stdout.close();
        ...
        if (!FILE.isReadable(temporaryPlistFilePath))
            (CPException.isa.method_msgSend["raise:reason:"] || _objj_forward)(CPException, "raise:reason:", ConverterConversionException, "Unable to convert nib file.");
    ...
    return (CPData.isa.method_msgSend["dataWithRawString:"] || _objj_forward)(CPData, "dataWithRawString:", plistContents);
    var ___r1;
}
...
{
    self = (objj_getClass("Nib2Cib").super_class.method_dtable["init"] || _objj_forward)(self, "init");
    if (self)
    {
        if (!SharedNib2Cib)
            SharedNib2Cib = self;
        ...
        self.nibInfo = {};
        self.appDirectory = "";
        self.frameworks = (CPDictionary.isa.method_msgSend["dictionary"] || _objj_forward)(CPDictionary, "dictionary");
        self.appResourceDirectory = "";
        self.infoPlist = (___r1 = (CPDictionary.isa.method_msgSend["alloc"] || _objj_forward)(CPDictionary, "alloc"), ___r1 == null ? null : (___r1.isa.method_msgSend["init"] || _objj_forward)(___r1, "init"));
        self.userNSClasses = [];
        self.themes = [];
    }
    return self;
...
{
    try {
        self.commandLineOptions = (self.isa.method_msgSend["parseOptionsFromArgs:"] || _objj_forward)(self, "parseOptionsFromArgs:", self.commandLineArgs);
        Nib2CibColorizeOutput = !self.commandLineOptions.noColors;
        (self.isa.method_msgSend["setLogLevel:"] || _objj_forward)(self, "setLogLevel:", self.commandLineOptions.quiet ? -1 : self.commandLineOptions.verbosity);
        (self.isa.method_msgSend["checkPrerequisites"] || _objj_forward)(self, "checkPrerequisites");
        if (self.commandLineOptions.watch)
            (self.isa.method_msgSend["watchWithOptions:"] || _objj_forward)(self, "watchWithOptions:", self.commandLineOptions);
        else
        {
            var success = (self.isa.method_msgSend["convertWithOptions:inputPath:"] || _objj_forward)(self, "convertWithOptions:inputPath:", self.commandLineOptions, nil);
            if (!success)
                OS.exit(1);
        }
    }
    catch(anException) {
        (self.isa.method_msgSend["logError:"] || _objj_forward)(self, "logError:", (self.isa.method_msgSend["exceptionReason:"] || _objj_forward)(self, "exceptionReason:", anException));
        OS.exit(1);
    }
}
...
,["void"]), new objj_method(sel_getUid("checkPrerequisites"), function $Nib2Cib__checkPrerequisites(self, _cmd)
{
    ...
    if (!info)
        (self.isa.method_msgSend["failWithMessage:"] || _objj_forward)(self, "failWithMessage:", "fontinfo does not appear to be installed");
}
...
,["void"]), new objj_method(sel_getUid("enumerateFrameworks"), function $Nib2Cib__enumerateFrameworks(self, _cmd)
{
    ...
    [debugFrameworksDirectory, frameworksDirectory].forEach(    function(directory)
    {
        if (FILE.isDirectory(directory))
        {
            ...
            {
                if (framework !== "Debug" && !((___r1 = self.frameworks), ___r1 == null ? null : (___r1.isa.method_msgSend["containsKey:"] || _objj_forward)(___r1, "containsKey:", framework)))
                {
                    ...
                    if (FILE.isDirectory(resourceDirectory))
                        ...
                        resourceDirectory = "";
                    ((___r1 = self.frameworks), ___r1 == null ? null : (___r1.isa.method_msgSend["setValue:forKey:"] || _objj_forward)(___r1, "setValue:forKey:", {resourceDirectory: resourceDirectory, loaded: false}, framework));
                }                var ___r1;
            });
        }    });
}
...
{
    try {
        inputPath = inputPath || (self.isa.method_msgSend["getInputPath:"] || _objj_forward)(self, "getInputPath:", options.args);
        (self.isa.method_msgSend["getAppAndResourceDirectoriesFromInputPath:options:"] || _objj_forward)(self, "getAppAndResourceDirectoriesFromInputPath:options:", inputPath, options);
        (self.isa.method_msgSend["enumerateFrameworks"] || _objj_forward)(self, "enumerateFrameworks");
        if (options.readStoredOptions)
        {
            options = (self.isa.method_msgSend["mergeOptionsWithStoredOptions:inputPath:"] || _objj_forward)(self, "mergeOptionsWithStoredOptions:inputPath:", options, inputPath);
            (self.isa.method_msgSend["setLogLevel:"] || _objj_forward)(self, "setLogLevel:", options.quiet ? -1 : options.verbosity);
        }
        if (!options.quiet && options.verbosity > 0)
            (self.isa.method_msgSend["printVersion"] || _objj_forward)(self, "printVersion");
        var configInfo = (self.isa.method_msgSend["readConfigFile:inputPath:"] || _objj_forward)(self, "readConfigFile:inputPath:", options.configFile || "", inputPath),
            outputPath = (self.isa.method_msgSend["getOutputPathFromInputPath:args:"] || _objj_forward)(self, "getOutputPathFromInputPath:args:", inputPath, options.args);
        self.infoPlist = configInfo.plist;
        if (self.infoPlist)
        {
            var systemFontFace = ((___r1 = self.infoPlist), ___r1 == null ? null : (___r1.isa.method_msgSend["valueForKey:"] || _objj_forward)(___r1, "valueForKey:", "CPSystemFontFace"));
            if (systemFontFace)
                (CPFont.isa.method_msgSend["setSystemFontFace:"] || _objj_forward)(CPFont, "setSystemFontFace:", systemFontFace);
            var systemFontSize = ((___r1 = self.infoPlist), ___r1 == null ? null : (___r1.isa.method_msgSend["valueForKey:"] || _objj_forward)(___r1, "valueForKey:", "CPSystemFontSize"));
            if (systemFontSize)
                (CPFont.isa.method_msgSend["setSystemFontSize:"] || _objj_forward)(CPFont, "setSystemFontSize:", parseFloat(systemFontSize, 10));
        }
        else
            self.infoPlist = (___r1 = (CPDictionary.isa.method_msgSend["alloc"] || _objj_forward)(CPDictionary, "alloc"), ___r1 == null ? null : (___r1.isa.method_msgSend["init"] || _objj_forward)(___r1, "init"));
        var themeList = (self.isa.method_msgSend["getThemeList:"] || _objj_forward)(self, "getThemeList:", options);
        (self.isa.method_msgSend["loadThemesFromList:"] || _objj_forward)(self, "loadThemesFromList:", themeList);
        (self.isa.method_msgSend["loadFrameworks:verbosity:"] || _objj_forward)(self, "loadFrameworks:verbosity:", options.frameworks, options.verbosity);
        var mainBundle = (CPBundle.isa.method_msgSend["mainBundle"] || _objj_forward)(CPBundle, "mainBundle");
        (mainBundle == null ? null : (mainBundle.isa.method_msgSend["loadWithDelegate:"] || _objj_forward)(mainBundle, "loadWithDelegate:", nil));
        (self.isa.method_msgSend["loadNSClassesFromBundle:"] || _objj_forward)(self, "loadNSClassesFromBundle:", mainBundle);
        var frameworkList = [];
        ((___r1 = self.frameworks), ___r1 == null ? null : (___r1.isa.method_msgSend["allKeys"] || _objj_forward)(___r1, "allKeys")).forEach(        function(name)
        {
            var info = ((___r1 = self.frameworks), ___r1 == null ? null : (___r1.isa.method_msgSend["valueForKey:"] || _objj_forward)(___r1, "valueForKey:", name));
        ...
        CPLog.info("System Font   : " + (CPFont.isa.method_msgSend["systemFontSize"] || _objj_forward)(CPFont, "systemFontSize") + "px " + (CPFont.isa.method_msgSend["systemFontFace"] || _objj_forward)(CPFont, "systemFontFace"));
        CPLog.info("NSClasses     : " + self.userNSClasses);
        CPLog.info("-------------------------------------------------------------\n");
        var converter = ((___r1 = (Converter.isa.method_msgSend["alloc"] || _objj_forward)(Converter, "alloc")), ___r1 == null ? null : (___r1.isa.method_msgSend["initWithInputPath:outputPath:"] || _objj_forward)(___r1, "initWithInputPath:outputPath:", inputPath, outputPath));
        (converter == null ? null : (converter.isa.method_msgSend["convert"] || _objj_forward)(converter, "convert"));
        return YES;
    }
    catch(anException) {
        (self.isa.method_msgSend["logError:"] || _objj_forward)(self, "logError:", (self.isa.method_msgSend["exceptionReason:"] || _objj_forward)(self, "exceptionReason:", anException));
...
,["BOOL","JSObject","CPString"]), new objj_method(sel_getUid("watchWithOptions:"), function $Nib2Cib__watchWithOptions_(self, _cmd, options)
{
    ...
    if (!FILE.isDirectory(watchDir))
        (self.isa.method_msgSend["failWithMessage:"] || _objj_forward)(self, "failWithMessage:", "Cannot find the directory: " + watchDir);
    (self.isa.method_msgSend["setLogLevel:"] || _objj_forward)(self, "setLogLevel:", 1);
    ...
    while (true)
    {
        var modifiedNibs = (self.isa.method_msgSend["getModifiedNibsInDirectory:"] || _objj_forward)(self, "getModifiedNibsInDirectory:", watchDir);
        for (var i = 0; i < modifiedNibs.length; ++i)
        {
            ...
            (self.isa.method_msgSend["setLogLevel:"] || _objj_forward)(self, "setLogLevel:", verbosity);
            var success = (self.isa.method_msgSend["convertWithOptions:inputPath:"] || _objj_forward)(self, "convertWithOptions:inputPath:", options, nib);
            (self.isa.method_msgSend["setLogLevel:"] || _objj_forward)(self, "setLogLevel:", 1);
            if (success)
            {
                if (verbosity > 0)
...
,["void","JSObject"]), new objj_method(sel_getUid("parseOptionsFromArgs:"), function $Nib2Cib__parseOptionsFromArgs_(self, _cmd, theArgs)
{
    ...
    {
        (self.isa.method_msgSend["printVersionAndExit"] || _objj_forward)(self, "printVersionAndExit");
...
{
    var userOptions = (self.isa.method_msgSend["readStoredOptionsAtPath:"] || _objj_forward)(self, "readStoredOptionsAtPath:", FILE.join(SYS.env["HOME"], ".nib2cibconfig")),
        appOptions = (self.isa.method_msgSend["readStoredOptionsAtPath:"] || _objj_forward)(self, "readStoredOptionsAtPath:", FILE.join(self.appDirectory, "nib2cib.conf")),
        filename = FILE.basename(inputPath, FILE.extension(inputPath)) + ".conf",
        fileOptions = (self.isa.method_msgSend["readStoredOptionsAtPath:"] || _objj_forward)(self, "readStoredOptionsAtPath:", FILE.join(FILE.dirname(inputPath), filename));
    userOptions = (self.isa.method_msgSend["parseOptionsFromArgs:"] || _objj_forward)(self, "parseOptionsFromArgs:", [options.command].concat(userOptions));
    appOptions = (self.isa.method_msgSend["parseOptionsFromArgs:"] || _objj_forward)(self, "parseOptionsFromArgs:", [options.command].concat(appOptions));
    fileOptions = (self.isa.method_msgSend["parseOptionsFromArgs:"] || _objj_forward)(self, "parseOptionsFromArgs:", [options.command].concat(fileOptions));
    var mergedOptions = userOptions;
    (self.isa.method_msgSend["mergeOptions:with:"] || _objj_forward)(self, "mergeOptions:with:", appOptions, mergedOptions);
    (self.isa.method_msgSend["mergeOptions:with:"] || _objj_forward)(self, "mergeOptions:with:", fileOptions, mergedOptions);
    (self.isa.method_msgSend["mergeOptions:with:"] || _objj_forward)(self, "mergeOptions:with:", options, mergedOptions);
...
,["void","int"]), new objj_method(sel_getUid("getInputPath:"), function $Nib2Cib__getInputPath_(self, _cmd, theArgs)
{
    ...
    {
        if (path = (self.isa.method_msgSend["findInputPath:extension:"] || _objj_forward)(self, "findInputPath:extension:", inputPath, ".xib"))
            inputPath = path;
        else if (path = (self.isa.method_msgSend["findInputPath:extension:"] || _objj_forward)(self, "findInputPath:extension:", inputPath, ".nib"))
            inputPath = path;
        else
            (self.isa.method_msgSend["failWithMessage:"] || _objj_forward)(self, "failWithMessage:", "Cannot find the input file (.xib or .nib): " + FILE.canonical(inputPath));
    }
    else if (path = (self.isa.method_msgSend["findInputPath:extension:"] || _objj_forward)(self, "findInputPath:extension:", inputPath, nil))
        inputPath = path;
    else
        (self.isa.method_msgSend["failWithMessage:"] || _objj_forward)(self, "failWithMessage:", "Could not read the input file: " + FILE.canonical(inputPath));
...
,["void","CPString","JSObject"]), new objj_method(sel_getUid("getOutputPathFromInputPath:args:"), function $Nib2Cib__getOutputPathFromInputPath_args_(self, _cmd, aPath, theArgs)
{
    ...
    if (!FILE.isWritable(FILE.dirname(outputPath)))
        (self.isa.method_msgSend["failWithMessage:"] || _objj_forward)(self, "failWithMessage:", "Cannot write the output file at: " + outputPath);
    return outputPath;
}
...
,["CPString","CPString","CPArray"]), new objj_method(sel_getUid("loadFrameworks:verbosity:"), function $Nib2Cib__loadFrameworks_verbosity_(self, _cmd, frameworksToLoad, verbosity)
{
    ...
    frameworksToLoad.forEach(    function(aFramework)
    {
        ...
        {
            frameworkPath = (self.isa.method_msgSend["findInFrameworks:path:isDirectory:callback:"] || _objj_forward)(self, "findInFrameworks:path:isDirectory:callback:", FILE.join(self.appDirectory, "Frameworks"), aFramework, YES,             function(path)
            {
                return path;
            });
        }        else
            (self.isa.method_msgSend["failWithMessage:"] || _objj_forward)(self, "failWithMessage:", "-F should be used only with a framework name that is in the app's Framework directory");
        if (!frameworkPath)
            (self.isa.method_msgSend["failWithMessage:"] || _objj_forward)(self, "failWithMessage:", "Cannot find the framework \"" + aFramework + "\"");
        CPLog.debug("Loading framework: " + frameworkPath);
        try {
            (self.isa.method_msgSend["setLogLevel:"] || _objj_forward)(self, "setLogLevel:", -1);
            var frameworkBundle = ((___r1 = (CPBundle.isa.method_msgSend["alloc"] || _objj_forward)(CPBundle, "alloc")), ___r1 == null ? null : (___r1.isa.method_msgSend["initWithPath:"] || _objj_forward)(___r1, "initWithPath:", frameworkPath));
            (frameworkBundle == null ? null : (frameworkBundle.isa.method_msgSend["loadWithDelegate:"] || _objj_forward)(frameworkBundle, "loadWithDelegate:", nil));
            (self.isa.method_msgSend["setLogLevel:"] || _objj_forward)(self, "setLogLevel:", verbosity);
            (self.isa.method_msgSend["loadNSClassesFromBundle:"] || _objj_forward)(self, "loadNSClassesFromBundle:", frameworkBundle);
            var frameworkName = FILE.basename(frameworkPath),
                info = ((___r1 = self.frameworks), ___r1 == null ? null : (___r1.isa.method_msgSend["valueForKey:"] || _objj_forward)(___r1, "valueForKey:", frameworkName));
            info.loaded = true;
        }
        finally {
            (self.isa.method_msgSend["setLogLevel:"] || _objj_forward)(self, "setLogLevel:", verbosity);
...
{
    var nsClasses = (aBundle == null ? null : (aBundle.isa.method_msgSend["objectForInfoDictionaryKey:"] || _objj_forward)(aBundle, "objectForInfoDictionaryKey:", "NSClasses")) || [],
        bundlePath = (aBundle == null ? null : (aBundle.isa.method_msgSend["bundlePath"] || _objj_forward)(aBundle, "bundlePath"));
...
,["void","CPBundle"]), new objj_method(sel_getUid("getThemeList:"), function $Nib2Cib__getThemeList_(self, _cmd, options)
{
    ...
    if (!defaultTheme)
        defaultTheme = ((___r1 = self.infoPlist), ___r1 == null ? null : (___r1.isa.method_msgSend["valueForKey:"] || _objj_forward)(___r1, "valueForKey:", "CPDefaultTheme"));
    if (!defaultTheme)
        defaultTheme = (self.isa.method_msgSend["getAppKitDefaultThemeName"] || _objj_forward)(self, "getAppKitDefaultThemeName");
    var themeList = (CPSet.isa.method_msgSend["setWithObject:"] || _objj_forward)(CPSet, "setWithObject:", defaultTheme);
    if (options.auxThemes)
        (themeList == null ? null : (themeList.isa.method_msgSend["addObjectsFromArray:"] || _objj_forward)(themeList, "addObjectsFromArray:", options.auxThemes));
    var auxThemes = self.infoPlist.valueForKey("CPAuxiliaryThemes");
    if (auxThemes)
        (themeList == null ? null : (themeList.isa.method_msgSend["addObjectsFromArray:"] || _objj_forward)(themeList, "addObjectsFromArray:", auxThemes));
    (themeList == null ? null : (themeList.isa.method_msgSend["removeObject:"] || _objj_forward)(themeList, "removeObject:", defaultTheme));
    var allThemes = (themeList == null ? null : (themeList.isa.method_msgSend["allObjects"] || _objj_forward)(themeList, "allObjects"));
    (allThemes == null ? null : (allThemes.isa.method_msgSend["insertObject:atIndex:"] || _objj_forward)(allThemes, "insertObject:atIndex:", defaultTheme, 0));
    return allThemes;
    var ___r1;
}
...
{
    return (self.isa.method_msgSend["findInFrameworks:path:isDirectory:callback:"] || _objj_forward)(self, "findInFrameworks:path:isDirectory:callback:", FILE.canonical(FILE.join(SYS.prefix, "packages/cappuccino/Frameworks")), path, isDirectory, callback);
}
...
,["id","CPString","CPString","BOOL","JSObject"]), new objj_method(sel_getUid("getAppKitDefaultThemeName"), function $Nib2Cib__getAppKitDefaultThemeName(self, _cmd)
{
    ...
    {
        return (self.isa.method_msgSend["themeNameFromPropertyList:"] || _objj_forward)(self, "themeNameFromPropertyList:", path);
    },
        themeName = (self.isa.method_msgSend["findInCappBuild:isDirectory:callback:"] || _objj_forward)(self, "findInCappBuild:isDirectory:callback:", "AppKit/Info.plist", NO, callback);
    if (!themeName)
        themeName = (self.isa.method_msgSend["findInInstalledFrameworks:isDirectory:callback:"] || _objj_forward)(self, "findInInstalledFrameworks:isDirectory:callback:", "AppKit/Info.plist", NO, callback);
...
,["CPString","CPString"]), new objj_method(sel_getUid("loadThemesFromList:"), function $Nib2Cib__loadThemesFromList_(self, _cmd, themeList)
{
    for (var i = 0; i < themeList.length; ++i)
        self.themes.push((self.isa.method_msgSend["loadThemeNamed:"] || _objj_forward)(self, "loadThemeNamed:", themeList[i]));
}
...
,["void","CPArray"]), new objj_method(sel_getUid("loadThemeNamed:"), function $Nib2Cib__loadThemeNamed_(self, _cmd, themeName)
{
    ...
    if (!themeDir)
    {
        ...
        themePath = (self.isa.method_msgSend["findInCappBuild:isDirectory:callback:"] || _objj_forward)(self, "findInCappBuild:isDirectory:callback:", blendName, YES, returnPath);
        if (!themePath)
            themePath = (self.isa.method_msgSend["findInInstalledFrameworks:isDirectory:callback:"] || _objj_forward)(self, "findInInstalledFrameworks:isDirectory:callback:", "AppKit/Resources/" + blendName, YES, returnPath);
        if (!themePath)
        {
    ...
    if (!themePath)
        (self.isa.method_msgSend["failWithMessage:"] || _objj_forward)(self, "failWithMessage:", "Cannot find the theme \"" + themeName + "\"");
    return (self.isa.method_msgSend["readThemeWithName:atPath:"] || _objj_forward)(self, "readThemeWithName:atPath:", themeName, themePath);
}
...
,["CPTheme","CPString"]), new objj_method(sel_getUid("readThemeWithName:atPath:"), function $Nib2Cib__readThemeWithName_atPath_(self, _cmd, name, path)
{
    ...
    if (!keyedThemes)
        (self.isa.method_msgSend["failWithMessage:"] || _objj_forward)(self, "failWithMessage:", "Could not find the keyed themes in the theme: " + path);
    var index = keyedThemes.indexOf(name + ".keyedtheme");
    if (index < 0)
        (self.isa.method_msgSend["failWithMessage:"] || _objj_forward)(self, "failWithMessage:", "Could not find the main theme data (" + name + ".keyedtheme" + ") in the theme: " + path);
    ...
    var theme = (CPKeyedUnarchiver.isa.method_msgSend["unarchiveObjectWithData:"] || _objj_forward)(CPKeyedUnarchiver, "unarchiveObjectWithData:", themeData);
    if (!theme)
        (self.isa.method_msgSend["failWithMessage:"] || _objj_forward)(self, "failWithMessage:", "Could not unarchive the theme at: " + path);
...
,["CPTheme","CPString","CPString"]), new objj_method(sel_getUid("readConfigFile:inputPath:"), function $Nib2Cib__readConfigFile_inputPath_(self, _cmd, configFile, inputPath)
{
    ...
    if (configFile)
    {
        ...
        if (!FILE.isReadable(path))
            (self.isa.method_msgSend["failWithMessage:"] || _objj_forward)(self, "failWithMessage:", "Cannot find the config file: " + path);
        configPath = path;
    }
    else
    {
    ...
    if (configPath)
    {
        ...
        if (!plist)
            (self.isa.method_msgSend["failWithMessage:"] || _objj_forward)(self, "failWithMessage:", "Could not read the Info.plist at: " + configPath);
        plist = CFPropertyList.propertyListFromString(plist);
        if (!plist)
            (self.isa.method_msgSend["failWithMessage:"] || _objj_forward)(self, "failWithMessage:", "Could not parse the Info.plist at: " + configPath);
    }
...
,["void"]), new objj_method(sel_getUid("exceptionReason:"), function $Nib2Cib__exceptionReason_(self, _cmd, exception)
{
    if (typeof exception === "string")
        return exception;
    else if (exception.isa && (exception == null ? null : (exception.isa.method_msgSend["respondsToSelector:"] || _objj_forward)(exception, "respondsToSelector:", sel_getUid("reason"))))
        return (exception == null ? null : (exception.isa.method_msgSend["reason"] || _objj_forward)(exception, "reason"));
    else
...
{
    (CPException.isa.method_msgSend["raise:reason:"] || _objj_forward)(CPException, "raise:reason:", ConverterConversionException, message);
}
...
{
    return (SharedNib2Cib == null ? null : (SharedNib2Cib.isa.method_msgSend["themes"] || _objj_forward)(SharedNib2Cib, "themes"))[0];
}
...
p;10;NSButton.jt;23444;@STATIC;1.0;I;17;AppKit/CPButton.jI;19;AppKit/CPCheckBox.jI;22;AppKit/CPPopUpButton.jI;16;AppKit/CPRadio.ji;8;NSCell.ji;11;NSControl.jt;23302;objj_executeFile("AppKit/CPButton.j", NO);objj_executeFile("AppKit/CPCheckBox.j", NO);objj_executeFile("AppKit/CPPopUpButton.j", NO);objj_executeFile("AppKit/CPRadio.j", NO);objj_executeFile("NSCell.j", YES);objj_executeFile("NSControl.j", YES);var NSButtonIsBorderedMask = 0x00800000,
...
{
    return (objj_getClass("CPButton").super_class.method_dtable["NS_initWithCoder:"] || _objj_forward)(self, "NS_initWithCoder:", aCoder);
}

,["id","CPCoder"]), new objj_method(sel_getUid("NS_initWithCell:"), function $CPButton__NS_initWithCell_(self, _cmd, cell)
{
    (objj_getClass("CPButton").super_class.method_dtable["NS_initWithCell:"] || _objj_forward)(self, "NS_initWithCell:", cell);
    var alternateImage = (cell == null ? null : (cell.isa.method_msgSend["alternateImage"] || _objj_forward)(cell, "alternateImage"));
    if ((alternateImage == null ? null : (alternateImage.isa.method_msgSend["isKindOfClass:"] || _objj_forward)(alternateImage, "isKindOfClass:", (NSButtonImageSource == null ? null : (NSButtonImageSource.isa.method_msgSend["class"] || _objj_forward)(NSButtonImageSource, "class")))))
    {
        if ((alternateImage == null ? null : (alternateImage.isa.method_msgSend["imageName"] || _objj_forward)(alternateImage, "imageName")) === "NSSwitch")
        {
            self.isa = (CPCheckBox.isa.method_msgSend["class"] || _objj_forward)(CPCheckBox, "class");
        }
        else if ((alternateImage == null ? null : (alternateImage.isa.method_msgSend["imageName"] || _objj_forward)(alternateImage, "imageName")) === "NSRadioButton")
        {
            self.isa = (CPRadio.isa.method_msgSend["class"] || _objj_forward)(CPRadio, "class");
            self._radioGroup = (CPRadioGroup.isa.method_msgSend["new"] || _objj_forward)(CPRadioGroup, "new");
        }
        self._themeClass = ((___r1 = (self.isa.method_msgSend["class"] || _objj_forward)(self, "class")), ___r1 == null ? null : (___r1.isa.method_msgSend["defaultThemeClass"] || _objj_forward)(___r1, "defaultThemeClass"));
        alternateImage = nil;
    }
    NIB_CONNECTION_EQUIVALENCY_TABLE[(cell == null ? null : (cell.isa.method_msgSend["UID"] || _objj_forward)(cell, "UID"))] = self;
    self._title = (cell == null ? null : (cell.isa.method_msgSend["title"] || _objj_forward)(cell, "title"));
    self._alternateTitle = (cell == null ? null : (cell.isa.method_msgSend["alternateTitle"] || _objj_forward)(cell, "alternateTitle"));
    (self.isa.method_msgSend["setBordered:"] || _objj_forward)(self, "setBordered:", (cell == null ? null : (cell.isa.method_msgSend["isBordered"] || _objj_forward)(cell, "isBordered")));
    self._bezelStyle = (cell == null ? null : (cell.isa.method_msgSend["bezelStyle"] || _objj_forward)(cell, "bezelStyle"));
    var fixedHeight;
...
default:
    ...
    if ((cell == null ? null : (cell.isa.method_msgSend["isBordered"] || _objj_forward)(cell, "isBordered")) || (self.isa.method_msgSend["isKindOfClass:"] || _objj_forward)(self, "isKindOfClass:", (CPRadio.isa.method_msgSend["class"] || _objj_forward)(CPRadio, "class")) || (self.isa.method_msgSend["isKindOfClass:"] || _objj_forward)(self, "isKindOfClass:", (CPCheckBox.isa.method_msgSend["class"] || _objj_forward)(CPCheckBox, "class")))
    {
        var theme = (Nib2Cib == null ? null : (Nib2Cib.isa.method_msgSend["defaultTheme"] || _objj_forward)(Nib2Cib, "defaultTheme")),
            minSize = (theme == null ? null : (theme.isa.method_msgSend["valueForAttributeWithName:forClass:"] || _objj_forward)(theme, "valueForAttributeWithName:forClass:", "min-size", (self.isa.method_msgSend["class"] || _objj_forward)(self, "class"))),
            maxSize = (theme == null ? null : (theme.isa.method_msgSend["valueForAttributeWithName:forClass:"] || _objj_forward)(theme, "valueForAttributeWithName:forClass:", "max-size", (self.isa.method_msgSend["class"] || _objj_forward)(self, "class"))),
            adjustHeight = NO;
    ...
    self._keyEquivalent = (cell == null ? null : (cell.isa.method_msgSend["keyEquivalent"] || _objj_forward)(cell, "keyEquivalent"));
    self._keyEquivalentModifierMask = (cell == null ? null : (cell.isa.method_msgSend["keyEquivalentModifierMask"] || _objj_forward)(cell, "keyEquivalentModifierMask"));
    self._imageDimsWhenDisabled = YES;
    self._allowsMixedState = (cell == null ? null : (cell.isa.method_msgSend["allowsMixedState"] || _objj_forward)(cell, "allowsMixedState"));
    (self.isa.method_msgSend["setImage:"] || _objj_forward)(self, "setImage:", (cell == null ? null : (cell.isa.method_msgSend["normalImage"] || _objj_forward)(cell, "normalImage")));
    (self.isa.method_msgSend["setAlternateImage:"] || _objj_forward)(self, "setAlternateImage:", alternateImage);
    (self.isa.method_msgSend["setImagePosition:"] || _objj_forward)(self, "setImagePosition:", (cell == null ? null : (cell.isa.method_msgSend["imagePosition"] || _objj_forward)(cell, "imagePosition")));
    ...
    self._highlightsBy = (cell == null ? null : (cell.isa.method_msgSend["highlightsBy"] || _objj_forward)(cell, "highlightsBy"));
    self._showsStateBy = (cell == null ? null : (cell.isa.method_msgSend["showsStateBy"] || _objj_forward)(cell, "showsStateBy"));
    var ___r1;
}

,["void","NSCell"]), new objj_method(sel_getUid("_nib2CibAdjustment"), function $CPButton___nib2CibAdjustment(self, _cmd)
{
    var frameAdjustment = (objj_getClass("CPButton").super_class.method_dtable["_nib2CibAdjustment"] || _objj_forward)(self, "_nib2CibAdjustment"),
        positionOffsetSizeWidth = 0,
        positionOffsetOriginX = 0,
        positionOffsetOriginY = 0;
    if (!(self.isa.method_msgSend["isBordered"] || _objj_forward)(self, "isBordered") || (self.isa.method_msgSend["isKindOfClass:"] || _objj_forward)(self, "isKindOfClass:", (CPPopUpButton.isa.method_msgSend["class"] || _objj_forward)(CPPopUpButton, "class")))
        return frameAdjustment;
    switch(self._bezelStyle) {
        case CPRoundedBezelStyle:
            switch((self.isa.method_msgSend["controlSize"] || _objj_forward)(self, "controlSize")) {
...
{
    return (CPButton.isa.method_msgSend["class"] || _objj_forward)(CPButton, "class");
}
...
{
    self = (objj_getClass("NSButtonCell").super_class.method_dtable["initWithCoder:"] || _objj_forward)(self, "initWithCoder:", aCoder);
    if (self)
    {
        var buttonFlags = (aCoder == null ? null : (aCoder.isa.method_msgSend["decodeIntForKey:"] || _objj_forward)(aCoder, "decodeIntForKey:", "NSButtonFlags")),
            buttonFlags2 = (aCoder == null ? null : (aCoder.isa.method_msgSend["decodeIntForKey:"] || _objj_forward)(aCoder, "decodeIntForKey:", "NSButtonFlags2")),
            cellFlags2 = (aCoder == null ? null : (aCoder.isa.method_msgSend["decodeIntForKey:"] || _objj_forward)(aCoder, "decodeIntForKey:", "NSCellFlags2")),
        ...
        self._title = (aCoder == null ? null : (aCoder.isa.method_msgSend["decodeObjectForKey:"] || _objj_forward)(aCoder, "decodeObjectForKey:", "NSContents"));
        self._alternateTitle = (aCoder == null ? null : (aCoder.isa.method_msgSend["decodeObjectForKey:"] || _objj_forward)(aCoder, "decodeObjectForKey:", "NSAlternateContents"));
        self._objectValue = (self == null ? null : (self.isa.method_msgSend["state"] || _objj_forward)(self, "state"));
        self._normalImage = (aCoder == null ? null : (aCoder.isa.method_msgSend["decodeObjectForKey:"] || _objj_forward)(aCoder, "decodeObjectForKey:", "NSNormalImage"));
        self._alternateImage = (aCoder == null ? null : (aCoder.isa.method_msgSend["decodeObjectForKey:"] || _objj_forward)(aCoder, "decodeObjectForKey:", "NSAlternateImage"));
        ...
        self._keyEquivalent = (aCoder == null ? null : (aCoder.isa.method_msgSend["decodeObjectForKey:"] || _objj_forward)(aCoder, "decodeObjectForKey:", "NSKeyEquivalent"));
...
{
    self = (objj_getClass("NSButtonImageSource").super_class.method_dtable["init"] || _objj_forward)(self, "init");
    if (self)
        self._imageName = (aCoder == null ? null : (aCoder.isa.method_msgSend["decodeObjectForKey:"] || _objj_forward)(aCoder, "decodeObjectForKey:", "NSImageName"));
    return self;
}
...
p;18;NSCustomResource.jt;4911;@STATIC;1.0;I;29;AppKit/_CPCibCustomResource.ji;18;Nib2CibException.jt;4835;objj_executeFile("AppKit/_CPCibCustomResource.j", NO);objj_executeFile("Nib2CibException.j", YES);var FILE = require("file"),
...
var meta_class = the_class.isa;class_addMethods(the_class, [new objj_method(sel_getUid("NS_initWithCoder:"), function $_CPCibCustomResource__NS_initWithCoder_(self, _cmd, aCoder)
{
    ...
    {
        self._className = CP_NSMapClassName((aCoder == null ? null : (aCoder.isa.method_msgSend["decodeObjectForKey:"] || _objj_forward)(aCoder, "decodeObjectForKey:", "NSClassName")));
        self._resourceName = (aCoder == null ? null : (aCoder.isa.method_msgSend["decodeObjectForKey:"] || _objj_forward)(aCoder, "decodeObjectForKey:", "NSResourceName"));
        ...
        else if (/^NS[A-Z][A-Za-z]+$/.test(self._resourceName))
        {
            if (supportedTemplateImages[self._resourceName])
            {
                ...
                (CPException.isa.method_msgSend["raise:format:"] || _objj_forward)(CPException, "raise:format:", Nib2CibException, "The built in image “%@” is not supported.", self._resourceName);
        }
        else
        {
            ...
            var resourceInfo = (aCoder == null ? null : (aCoder.isa.method_msgSend["resourceInfoForName:inFramework:"] || _objj_forward)(aCoder, "resourceInfoForName:inFramework:", self._resourceName, framework));
            if (!resourceInfo)
        ...
        if (resourceInfo && resourceInfo.path && resourceInfo.framework)
        {
            var frameworkPath = FILE.dirname(FILE.dirname(resourceInfo.path)),
                bundle = (CPBundle.isa.method_msgSend["bundleWithPath:"] || _objj_forward)(CPBundle, "bundleWithPath:", frameworkPath);
            (bundle == null ? null : (bundle.isa.method_msgSend["loadWithDelegate:"] || _objj_forward)(bundle, "loadWithDelegate:", nil));
            bundleIdentifier = (bundle == null ? null : (bundle.isa.method_msgSend["bundleIdentifier"] || _objj_forward)(bundle, "bundleIdentifier")) || "";
        }
        self._properties = (___r1 = (CPDictionary.isa.method_msgSend["alloc"] || _objj_forward)(CPDictionary, "alloc"), ___r1 == null ? null : (___r1.isa.method_msgSend["initWithObjects:forKeys:"] || _objj_forward)(___r1, "initWithObjects:forKeys:", [size, bundleIdentifier, framework], ["size", "bundleIdentifier", "framework"]));
...
{
    return (_CPCibCustomResource.isa.method_msgSend["class"] || _objj_forward)(_CPCibCustomResource, "class");
}
...
p;15;NSOutlineView.jt;3092;@STATIC;1.0;I;22;AppKit/CPOutlineView.jt;3046;objj_executeFile("AppKit/CPOutlineView.j", NO);{
...
p;19;NSTableHeaderView.jt;1984;@STATIC;1.0;I;26;AppKit/CPTableHeaderView.jt;1934;objj_executeFile("AppKit/CPTableHeaderView.j", NO);{
...
{
    if (self = (objj_getClass("CPTableHeaderView").super_class.method_dtable["NS_initWithCoder:"] || _objj_forward)(self, "NS_initWithCoder:", aCoder))
    {
        self._tableView = (aCoder == null ? null : (aCoder.isa.method_msgSend["decodeObjectForKey:"] || _objj_forward)(aCoder, "decodeObjectForKey:", "NSTableView"));
        if (self._bounds.size.height === 17)
        {
            var theme = (Nib2Cib == null ? null : (Nib2Cib.isa.method_msgSend["defaultTheme"] || _objj_forward)(Nib2Cib, "defaultTheme")),
                height = (theme == null ? null : (theme.isa.method_msgSend["valueForAttributeWithName:forClass:"] || _objj_forward)(theme, "valueForAttributeWithName:forClass:", "default-row-height", CPTableView));
            self._bounds.size.height = height;
            self._frame.size.height = height;
        }
    }
...
{
    return (CPTableHeaderView.isa.method_msgSend["class"] || _objj_forward)(CPTableHeaderView, "class");
}

,["Class"])]);
}
p;13;NSTableView.jt;5811;@STATIC;1.0;I;20;AppKit/CPTableView.jt;5767;objj_executeFile("AppKit/CPTableView.j", NO);{
...
{
    self = (objj_getClass("CPTableView").super_class.method_dtable["NS_initWithCoder:"] || _objj_forward)(self, "NS_initWithCoder:", aCoder);
    if (self)
    {
        var flags = (aCoder == null ? null : (aCoder.isa.method_msgSend["decodeIntForKey:"] || _objj_forward)(aCoder, "decodeIntForKey:", "NSTvFlags"));
        self._rowHeight = (aCoder == null ? null : (aCoder.isa.method_msgSend["decodeFloatForKey:"] || _objj_forward)(aCoder, "decodeFloatForKey:", "NSRowHeight"));
        ...
        self._headerView = (aCoder == null ? null : (aCoder.isa.method_msgSend["decodeObjectForKey:"] || _objj_forward)(aCoder, "decodeObjectForKey:", "NSHeaderView"));
        self._cornerView = self._headerView ? (aCoder == null ? null : (aCoder.isa.method_msgSend["decodeObjectForKey:"] || _objj_forward)(aCoder, "decodeObjectForKey:", "NSCornerView")) : nil;
        ((___r1 = self._cornerView), ___r1 == null ? null : (___r1.isa.method_msgSend["setHidden:"] || _objj_forward)(___r1, "setHidden:", NO));
        self._autosaveName = (aCoder == null ? null : (aCoder.isa.method_msgSend["decodeObjectForKey:"] || _objj_forward)(aCoder, "decodeObjectForKey:", "NSAutosaveName"));
        self._tableColumns = (aCoder == null ? null : (aCoder.isa.method_msgSend["decodeObjectForKey:"] || _objj_forward)(aCoder, "decodeObjectForKey:", "NSTableColumns"));
        ...
        self._archivedDataViews = (aCoder == null ? null : (aCoder.isa.method_msgSend["decodeObjectForKey:"] || _objj_forward)(aCoder, "decodeObjectForKey:", "NSTableViewArchivedReusableViewsKey"));
        self._intercellSpacing = CGSizeMake((aCoder == null ? null : (aCoder.isa.method_msgSend["decodeFloatForKey:"] || _objj_forward)(aCoder, "decodeFloatForKey:", "NSIntercellSpacingWidth")), (aCoder == null ? null : (aCoder.isa.method_msgSend["decodeFloatForKey:"] || _objj_forward)(aCoder, "decodeFloatForKey:", "NSIntercellSpacingHeight")));
        (self == null ? null : (self.isa.method_msgSend["setValue:forThemeAttribute:"] || _objj_forward)(self, "setValue:forThemeAttribute:", (aCoder == null ? null : (aCoder.isa.method_msgSend["decodeObjectForKey:"] || _objj_forward)(aCoder, "decodeObjectForKey:", "NSGridColor")), "grid-color"));
        self._gridStyleMask = (aCoder == null ? null : (aCoder.isa.method_msgSend["decodeIntForKey:"] || _objj_forward)(aCoder, "decodeIntForKey:", "NSGridStyleMask"));
        ...
        self._selectionHighlightStyle = (aCoder == null ? null : (aCoder.isa.method_msgSend["decodeIntForKey:"] || _objj_forward)(aCoder, "decodeIntForKey:", "NSTableViewSelectionHighlightStyle"));
        self._columnAutoResizingStyle = (aCoder == null ? null : (aCoder.isa.method_msgSend["decodeIntForKey:"] || _objj_forward)(aCoder, "decodeIntForKey:", "NSColumnAutoresizingStyle"));
        self._allowsMultipleSelection = flags & 0x08000000 ? YES : NO;
        self._allowsEmptySelection = flags & 0x10000000 ? YES : NO;
        ...
        (self == null ? null : (self.isa.method_msgSend["setBackgroundColor:"] || _objj_forward)(self, "setBackgroundColor:", (aCoder == null ? null : (aCoder.isa.method_msgSend["decodeObjectForKey:"] || _objj_forward)(aCoder, "decodeObjectForKey:", "NSBackgroundColor"))));
    }
    return self;
    var ___r1;
}
...
{
    return (CPTableView.isa.method_msgSend["class"] || _objj_forward)(CPTableView, "class");
}
...
p;13;NSTextField.jt;9153;@STATIC;1.0;I;15;AppKit/CPFont.jI;20;AppKit/CPTextField.ji;8;NSCell.ji;11;NSControl.jt;9061;objj_executeFile("AppKit/CPFont.j", NO);objj_executeFile("AppKit/CPTextField.j", NO);objj_executeFile("NSCell.j", YES);objj_executeFile("NSControl.j", YES);{
...
{
    return (objj_getClass("CPTextField").super_class.method_dtable["NS_initWithCoder:"] || _objj_forward)(self, "NS_initWithCoder:", aCoder);
}

,["id","CPCoder"]), new objj_method(sel_getUid("NS_initWithCell:"), function $CPTextField__NS_initWithCell_(self, _cmd, cell)
{
    (objj_getClass("CPTextField").super_class.method_dtable["NS_initWithCell:"] || _objj_forward)(self, "NS_initWithCell:", cell);
    (self.isa.method_msgSend["setEditable:"] || _objj_forward)(self, "setEditable:", (cell == null ? null : (cell.isa.method_msgSend["isEditable"] || _objj_forward)(cell, "isEditable")));
    (self.isa.method_msgSend["setEnabled:"] || _objj_forward)(self, "setEnabled:", (cell == null ? null : (cell.isa.method_msgSend["isEnabled"] || _objj_forward)(cell, "isEnabled")));
    (self.isa.method_msgSend["setSelectable:"] || _objj_forward)(self, "setSelectable:", (cell == null ? null : (cell.isa.method_msgSend["isSelectable"] || _objj_forward)(cell, "isSelectable")));
    (self.isa.method_msgSend["setSendsActionOnEndEditing:"] || _objj_forward)(self, "setSendsActionOnEndEditing:", (cell == null ? null : (cell.isa.method_msgSend["sendsActionOnEndEditing"] || _objj_forward)(cell, "sendsActionOnEndEditing")));
    (self.isa.method_msgSend["setBordered:"] || _objj_forward)(self, "setBordered:", (cell == null ? null : (cell.isa.method_msgSend["isBordered"] || _objj_forward)(cell, "isBordered")));
    (self.isa.method_msgSend["setBezeled:"] || _objj_forward)(self, "setBezeled:", (cell == null ? null : (cell.isa.method_msgSend["isBezeled"] || _objj_forward)(cell, "isBezeled")));
    (self.isa.method_msgSend["setBezelStyle:"] || _objj_forward)(self, "setBezelStyle:", (cell == null ? null : (cell.isa.method_msgSend["bezelStyle"] || _objj_forward)(cell, "bezelStyle")));
    (self.isa.method_msgSend["setDrawsBackground:"] || _objj_forward)(self, "setDrawsBackground:", (cell == null ? null : (cell.isa.method_msgSend["drawsBackground"] || _objj_forward)(cell, "drawsBackground")));
    (self.isa.method_msgSend["setLineBreakMode:"] || _objj_forward)(self, "setLineBreakMode:", (cell == null ? null : (cell.isa.method_msgSend["lineBreakMode"] || _objj_forward)(cell, "lineBreakMode")));
    (self.isa.method_msgSend["setAlignment:"] || _objj_forward)(self, "setAlignment:", (cell == null ? null : (cell.isa.method_msgSend["alignment"] || _objj_forward)(cell, "alignment")));
    (self.isa.method_msgSend["setTextFieldBackgroundColor:"] || _objj_forward)(self, "setTextFieldBackgroundColor:", (cell == null ? null : (cell.isa.method_msgSend["backgroundColor"] || _objj_forward)(cell, "backgroundColor")));
    (self.isa.method_msgSend["setPlaceholderString:"] || _objj_forward)(self, "setPlaceholderString:", (cell == null ? null : (cell.isa.method_msgSend["placeholderString"] || _objj_forward)(cell, "placeholderString")));
    (self.isa.method_msgSend["_setUsesSingleLineMode:"] || _objj_forward)(self, "_setUsesSingleLineMode:", (cell == null ? null : (cell.isa.method_msgSend["usesSingleLineMode"] || _objj_forward)(cell, "usesSingleLineMode")));
    (self.isa.method_msgSend["_setWraps:"] || _objj_forward)(self, "_setWraps:", (cell == null ? null : (cell.isa.method_msgSend["wraps"] || _objj_forward)(cell, "wraps")));
    (self.isa.method_msgSend["_setScrolls:"] || _objj_forward)(self, "_setScrolls:", (cell == null ? null : (cell.isa.method_msgSend["scrolls"] || _objj_forward)(cell, "scrolls")));
    var textColor = (cell == null ? null : (cell.isa.method_msgSend["textColor"] || _objj_forward)(cell, "textColor")),
        defaultColor = (self.isa.method_msgSend["currentValueForThemeAttribute:"] || _objj_forward)(self, "currentValueForThemeAttribute:", "text-color");
    if (!(textColor == null ? null : (textColor.isa.method_msgSend["isEqual:"] || _objj_forward)(textColor, "isEqual:", defaultColor)))
        (self.isa.method_msgSend["setTextColor:"] || _objj_forward)(self, "setTextColor:", (cell == null ? null : (cell.isa.method_msgSend["textColor"] || _objj_forward)(cell, "textColor")));
    CPLog.debug("NSTextField: title=\"" + (self.isa.method_msgSend["stringValue"] || _objj_forward)(self, "stringValue") + "\", placeholder=" + ((cell == null ? null : (cell.isa.method_msgSend["placeholderString"] || _objj_forward)(cell, "placeholderString")) == null ? "<none>" : '"' + (cell == null ? null : (cell.isa.method_msgSend["placeholderString"] || _objj_forward)(cell, "placeholderString")) + '"') + ", isBordered=" + (self.isa.method_msgSend["isBordered"] || _objj_forward)(self, "isBordered") + ", isBezeled=" + (self.isa.method_msgSend["isBezeled"] || _objj_forward)(self, "isBezeled") + ", bezelStyle=" + (self.isa.method_msgSend["bezelStyle"] || _objj_forward)(self, "bezelStyle"));
    if ((self.isa.method_msgSend["formatter"] || _objj_forward)(self, "formatter"))
        CPLog.debug(">> Formatter: " + ((___r1 = (self.isa.method_msgSend["formatter"] || _objj_forward)(self, "formatter")), ___r1 == null ? null : (___r1.isa.method_msgSend["description"] || _objj_forward)(___r1, "description")));
    var ___r1;
}
...
{
    return (CPTextField.isa.method_msgSend["class"] || _objj_forward)(CPTextField, "class");
}
...
{
    self = (objj_getClass("NSTextFieldCell").super_class.method_dtable["initWithCoder:"] || _objj_forward)(self, "initWithCoder:", aCoder);
    if (self)
    {
        self._bezelStyle = (aCoder == null ? null : (aCoder.isa.method_msgSend["decodeObjectForKey:"] || _objj_forward)(aCoder, "decodeObjectForKey:", "NSTextBezelStyle")) || CPTextFieldSquareBezel;
        self._drawsBackground = (aCoder == null ? null : (aCoder.isa.method_msgSend["decodeBoolForKey:"] || _objj_forward)(aCoder, "decodeBoolForKey:", "NSDrawsBackground"));
        self._backgroundColor = (aCoder == null ? null : (aCoder.isa.method_msgSend["decodeObjectForKey:"] || _objj_forward)(aCoder, "decodeObjectForKey:", "NSBackgroundColor"));
        self._textColor = (aCoder == null ? null : (aCoder.isa.method_msgSend["decodeObjectForKey:"] || _objj_forward)(aCoder, "decodeObjectForKey:", "NSTextColor"));
        self._placeholderString = (aCoder == null ? null : (aCoder.isa.method_msgSend["decodeObjectForKey:"] || _objj_forward)(aCoder, "decodeObjectForKey:", "NSPlaceholderString"));
    }
    return self;
}
...
p;28;NSToolbarFlexibleSpaceItem.jt;584;@STATIC;1.0;I;36;AppKit/_CPToolbarFlexibleSpaceItem.jt;525;objj_executeFile("AppKit/_CPToolbarFlexibleSpaceItem.j", NO);
