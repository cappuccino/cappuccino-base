@STATIC;1.0;p;15;Configuration.jt;7417;@STATIC;1.0;I;25;Foundation/CPDictionary.jI;21;Foundation/CPString.jI;21;Foundation/CPObject.jI;18;Foundation/CPSet.jt;7293;
...
class_addMethods(the_class, [new objj_method(sel_getUid("initWithPath:"), function $Configuration__initWithPath_(self, _cmd, aPath)
{
    ...
    {
        self.path = aPath;
        self.temporaryDictionary = objj_msgSend(CPDictionary, "dictionary");
        ...
        if (!self.dictionary)
            self.dictionary = objj_msgSend(CPDictionary, "dictionary");
    }
...
}p;10;Generate.jt;11819;@STATIC;1.0;i;15;Configuration.jt;11779;objj_executeFile("Configuration.j", YES);
var OS = require("os"),
    SYSTEM = require("system"),
    FILE = require("file"),
